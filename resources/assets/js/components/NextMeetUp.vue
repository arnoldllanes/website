    ...
    <div class="image-popup text-center">
        <div id="meetup-component">
            ...
            <ul class="meetup-list-display">
                <li><i class="fa fa-clock-o" aria-hidden="true"></i> <span id="meetup-when">{{ meetup.time }}</span>
                </li>
                <li><i class="fa fa-users" aria-hidden="true"></i> Rsvps: <span
                        id="meetup-rsvps">{{ meetup.rsvps }}</span></li>
